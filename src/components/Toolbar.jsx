    ...
    <div>
      ...
      <div id='tblTools' className="Toolbar" style={{ display: "flex", flexDirection: "row" }}>
        ...
        <div style={{ margin: '23px 0 0 10px' }}>
          <img src={Imgprint} onClick={()=>navigate("/print", { state: { componentToPrint:'filters'} })} title="print unit list" style={{ border: '3px solid green', height: '50px', borderRadius: '50%', cursor:"pointer", boxShadow: ' 4px 4px black', }} />
        </div>
        <div>
        </div>
